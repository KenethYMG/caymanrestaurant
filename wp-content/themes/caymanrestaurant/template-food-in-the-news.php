<?php
/*
Template Name: Template Food in the news
*/
...
<div class="container-fluid   px-0">
    ...
    <div class="description_chef_inner_green w-100 font_Trebuchet mb-md-5 mb-lg-5">
 ...
 <?php 
    require("archive-food-in-the-news.php");
 ?>
